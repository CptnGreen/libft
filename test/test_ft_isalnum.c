...
void test_zero_char(void)
{
    ...
    TEST_ASSERT_GREATER_THAN(0, ft_isalnum('0'));
}

void test_three_char(void)
{
    // TEST_ASSERT_EQUAL_INT(isalnum('3'), ft_isalnum('3'));
    TEST_ASSERT_GREATER_THAN(0, ft_isalnum('3'));
}

void test_a(void)
{
    // TEST_ASSERT_EQUAL_INT(isalnum('a'), ft_isalnum('a'));
    TEST_ASSERT_GREATER_THAN(0, ft_isalnum('a'));
}
...
void test_max(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(0, ft_isalnum(UCHAR_MAX));
}

void test_almost_max(void)
{
    // TEST_ASSERT_EQUAL_INT(isalnum(UCHAR_MAX - 1), ft_isalnum(UCHAR_MAX - 1));
    TEST_ASSERT_EQUAL_INT(0, ft_isalnum(UCHAR_MAX - 1));
}
