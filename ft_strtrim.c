...
/*
** Description: ft_strtrim() allocates (with malloc(3)) and returns a copy of the string
** given as argument without whitespaces at the beginning or at the end of the string.
